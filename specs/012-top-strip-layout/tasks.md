...
- [X] T017 [P] Run `npm test` (builds `dist/`, then the full `vitest`
  ...
  SC-006).
- [X] T018 [P] Review the full diff against `main` and confirm it touches no
